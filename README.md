...
- [Transcription support](#transcription-support)
  ...
  - [Option 2: External Skynet (managed outside this chart)](#option-2-external-skynet-managed-outside-this-chart)
  - [Option 3: A different backend](#option-3-a-different-backend)
